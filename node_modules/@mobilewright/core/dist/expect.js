...
class LocatorAssertions {
    ...
    async assertBoolean(name, poll, opts) {
        await this.retryUntil(poll, (result) => (this.negated ? !result : result), opts?.timeout ?? DEFAULT_TIMEOUT, this.negated
    ...
    async retryUntil(poll, predicate, timeout, failMessage) {
